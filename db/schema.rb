...
ActiveRecord::Schema.define(:version => 20140109204049) do
  ...
  create_table "resumes", :force => true do |t|
    ...
    t.decimal  "ret_isr",           :precision => 11, :scale => 2, :default => 0.0
    t.decimal  "ret_iva",           :precision => 11, :scale => 2, :default => 0.0
    t.decimal  "subtotal",          :precision => 11, :scale => 2, :default => 0.0
    t.decimal  "total",             :precision => 11, :scale => 2, :default => 0.0
    t.decimal  "iva",               :precision => 11, :scale => 2, :default => 0.0
